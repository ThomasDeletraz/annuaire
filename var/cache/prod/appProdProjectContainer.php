...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'contactbasiquerepository' => 'getContactbasiquerepositoryService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UBN4t-kJK6', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AstqOcq+-9', '', 'ffA4A0pdZURJ08oy6jz0Lw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qL0vPx0qdn', '', 'ffA4A0pdZURJ08oy6jz0Lw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    /*
     * Gets the 'contactbasiquerepository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Repository\ContactBasique A AppBundle\Repository\ContactBasique instance
     */
    protected function getContactbasiquerepositoryService()
    {
        return $this->services['contactbasiquerepository'] = new \AppBundle\Repository\ContactBasique($this->get('doctrine'), $this->get('doctrine.dbal.default_connection'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'annuaire', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_27e64e26bf2e832cca3f92b84cdd4b8ed46f4e35bf71f9e7d0324f119a672cef');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\Extension\Miscellaneous());
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c24ea1d80abff20838596ff929c20afd879eb082');
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+1oWpHiR2u', '', 'ffA4A0pdZURJ08oy6jz0Lw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57bf7ddfd89ad4.06089981')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'c24ea1d80abff20838596ff929c20afd879eb082',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'c24ea1d80abff20838596ff929c20afd879eb082',
            ...
            'validator.mapping.cache.prefix' => 'validator_01f2787d76e63f2dbb3ac0a4e4502e87d988c7b27fcdaaf2e3d6133fd207be4d',
